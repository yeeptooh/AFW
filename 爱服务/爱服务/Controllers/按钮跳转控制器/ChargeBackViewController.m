...
#import "UserModel.h"
#import "ChargeBackReasonViewController.h"
...
- (void)chargeBackButtonClicked:(UIButton *)sender {
    ChargeBackReasonViewController *cbrVC = [[ChargeBackReasonViewController alloc]init];
    cbrVC.reasonList = [NSMutableArray arrayWithArray:@[@"用户主动取消",@"厂商网点协商一致"]];
    cbrVC.returnReason = ^(NSString *reason) {
